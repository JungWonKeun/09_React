    ...
    <div className="signup-container">
      <div className="label-wrapper">
        ...
        <input 
          ...
          className={`glow-input ${idValidation ? '' : 'id-error'}`}
          value={id}
        />
      </div>
      ...
      <hr/>
      <button onClick={signUpHandler} className="glow-button">가입하기</button>
  
      <hr/>
  
      {/* 회원 가입 결과 메시지 */}
      <h3 className='resultMessage'>{result}</h3>
    </div>
  );
}
